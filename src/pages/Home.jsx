    ...
    <>
      ...
      <section className="bg-primary text-primary py-20 px-0">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          {/* View More Card */}
          <div className="group border mx-6 md:mx-0 border-divider bg-primary/40 backdrop-blur-md rounded-xl shadow-md hover:shadow-xl transform transition-all duration-300 hover:scale-105 hover:rotate-[0.5deg] flex items-center justify-center h-100 w-110 md:w-full hover:border-highlight cursor-pointer">
            <Link to="/projects">
              <div className="flex justify-center items-center w-14 h-14 rounded-full bg-secondary text-primary transition-all duration-300 group-hover:bg-highlight group-hover:text-white">
                <ArrowForwardIosIcon />
              </div>

              <p className="mt-6 flex items-center justify-center text-primary">
                View More
              </p>
            </Link>
          </div>
